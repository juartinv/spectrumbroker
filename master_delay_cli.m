...
# y comparar la diferecia que cada uno de ellos obtiene al emplear y al prescindir de la adaptación 
# de tolerancia a la demora de la obtención del resultado de cada decision.
# 
# Los resultados se guardan donde se indique y se  procesan para obtener graficas y estadisticas 
# con post_proc_delay.m
#
# Existe un caso alternativo implementado en master_delay_alt.m

if (nargin != 2)
    error("Uso desde la shell de linux: octave-cli -q master_delay_cli.m  <region:maximal, saturada, borde, total> <filename.mat>")
endif
arg_list = argv ();
...
clear -x C fparam_global parametros parciales payoff_evol m estadistica_full estadistica_summ iteraciones repeticiones delay_tolerance_global programas archivomat
