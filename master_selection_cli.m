...
#   juan vanerio, 2017
#
# Este script se utiliza para simular planes de eventos Poisson de diferentes puntos de operación con 
# todos los mecanismos de prediccion desarrollados y comparar los resultados obtenidos por cada uno
# y de ese modo realizar la seleccion de los mejores de ellos.
#
# En las pruebas mas complejas de este trabajo solo se utilizan los mecanismos seleccionados en esta 
# prueba.
# 
# Los resultados se guardan donde se indique y se procesan para obtener graficas y estadisticas 
# con post_proc_selection.m
#



if (nargin != 2)
    error("Uso desde la shell de linux: octave-cli -q master_selection_cli.m  <region:maximal, saturada, borde, total> <filename.mat>")
endif
arg_list = argv ();
init
